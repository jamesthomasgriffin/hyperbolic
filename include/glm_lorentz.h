...
hermitian_matrix_to_vec(ImaginaryExtension<mat<2, 2, T, Q>> const &M) {
  vec<4, T, Q> result{};
  result[0] = M.real[0][1];
  result[1] = M.imag[1][0];
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, T, Q>
symmetric_matrix_to_vec(mat<2, 2, T, Q> const &M) {
  vec<4, T, Q> result{};
  result[0] = M[0][1];
  result[1] = 0;
...
action_via_hermitian_matrix(ImaginaryExtension<mat<2, 2, T, Q>> const &M) {

  ImaginaryExtension<mat<2, 2, T, Q>> const Mct{glm::transpose(M.real),
                                                -glm::transpose(M.imag)};

  // NB Ew is the identity so isn't needed
  ImaginaryExtension<mat<2, 2, T, Q>> Ex{mat<2, 2, T, Q>{0, 1, 1, 0},
                                         mat<2, 2, T, Q>{0, 0, 0, 0}};
  ImaginaryExtension<mat<2, 2, T, Q>> Ey{mat<2, 2, T, Q>{0, 0, 0, 0},
                                         mat<2, 2, T, Q>{0, -1, 1, 0}};
  ImaginaryExtension<mat<2, 2, T, Q>> Ez{mat<2, 2, T, Q>{1, 0, 0, -1},
                                         mat<2, 2, T, Q>{0, 0, 0, 0}};
...
// a simplification of action_via_hermitian_matrix for when M is real and symmetric
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 4, T, Q>
action_via_symmetric_matrix(mat<2, 2, T, Q> const &M) {

  mat<2, 2, T, Q> const Mct = glm::transpose(M);

  // NB Ew is the identity so isn't needed
  mat<2, 2, T, Q> Ex{0, 1, 1, 0};
  mat<2, 2, T, Q> imagEy{0, -1, 1, 0};
  mat<2, 2, T, Q> Ez{1, 0, 0, -1};
